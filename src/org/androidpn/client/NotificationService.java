...
import com.lte.util.WakeLockUtil;
...
public class NotificationService extends Service {
	...
	public static final String SERVICE_NAME = "org.androidpn.client.NotificationService.Research";
	...
	public void onStart(Intent intent, int startId) {
		...
		System.out.println("onStart开启NotificationService...");
		// taskSubmitter.submit(new Runnable() {
		// public void run() {
		// NotificationService.this.start();
		// }
		// });
		// 次代码解决锁屏掉线收不到消息的bug，原因锁屏后，系统休眠，心跳不能正常发送
		// 不添加锁屏3分钟后就推送失败，添加后20---30分钟左右失败
	...
	public void onDestroy() {
		...
		System.out.println("销毁NotificationService...");
		stop();
	}
	...
	private void start() {
		Log.d(LOGTAG, "start()...");
		System.out.println("开始NotificationService...");
	...
	private void stop() {
		Log.d(LOGTAG, "stop()...");
		System.out.println("停止NotificationService...");
